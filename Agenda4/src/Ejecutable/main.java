...
public class main {
    ...
    public static void main(String[] args) {
        ...
        while (aceptado != true) {
            try {
                System.out.println("¿Que nombre tiene el archivo?");
                String nombreArchivo1 = sc.nextLine();
                directorio = "C:\\Programacion\\netbeans\\proyectos\\Agenda3\\ficherosAgenda\\" + nombreArchivo1;
                Contactos.abrirAgenda(directorio);
                aceptado = true;
            } catch (FileNotFoundException ex) {
                System.out.println("El fichero no se ha podido encontrar: " + ex);
            } catch (IOException ex) {
                System.out.println("No se puede leer el archivo o esta corrupto: " + ex);
            } catch (ClassNotFoundException ex) {
                System.out.println("El programa esta incompleto: " + ex);
            }
        }
                ...
                switch (str_original) {
                    case "1":
                        ...
                        switch (str_ordenes) {
                            ...
                            break;
                            /*Caso L: Revisar nota en Agenda; linea 247*/
                            case "L": {
                                System.out.println("Nombre");
                                String nombreprueba = sc.nextLine();
                                try {
                                    Contactos.lectorFicheros("C:\\Programacion\\netbeans\\proyectos\\Agenda3\\ficherosAgenda\\"+nombreprueba);
                                } catch (IOException ex) {
                                    System.out.println("Error: " + ex);
                                } catch (Exception ex) {
                                    System.out.println("Error: "+ ex);
